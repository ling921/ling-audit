...
public static class ModelBuilderExtensions
{
    ...
    public static EntityTypeBuilder IsAuditEnabled(this EntityTypeBuilder entityTypeBuilder, AuditOperate allowAnonymousOperate = AuditOperate.None)
    {
    ...
    /// <summary>
    /// Configure disable auditing to be applied to the column.
    /// </summary>
    /// <param name="propertyBuilder">The builder for the property being configured.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public static PropertyBuilder IsAuditIgnored(this PropertyBuilder propertyBuilder)
    {
