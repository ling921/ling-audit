...
internal sealed class AuditSymbols(Compilation compilation)
{
    ...
    public INamedTypeSymbol IHasModifier => compilation.GetTypeByMetadataName(AuditDefaults.IHasModifierTypeFullQualifiedMetadataName)!;
    public INamedTypeSymbol IHasModificationTime => compilation.GetTypeByMetadataName(AuditDefaults.IHasModificationTimeTypeFullQualifiedMetadataName)!;
